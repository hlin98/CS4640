...
<body>
    ...
    <div align="center">
        <div align="left" class="profilebox" style="margin-top: 30px; width: 1000px; padding: 20px; flex-direction: row; display: flex; justify-content: space-between;">
            <div align="center" style="background-color: white; width: 300px;">
                <img class="profile-pic" width="250" src="https://vignette.wikia.nocookie.net/caramella-girls/images/9/99/Blankpfp.png/revision/latest?cb=20190122015011">
                <div align="center" style="padding: 35px;">
                    <input class="file-upload" type="file" accept="image/*"/>
                    <div align="center" style="display: flex; flex-direction: row; font-size: 12px; margin-top: 20px; justify-content: space-around;">
                        <img src="https://image.flaticon.com/icons/svg/61/61183.svg" width="20" height="20" onclick="follow_user();" />    
                        <div id="followuser" style="color: #fd455c;">
                        <p>Currently not following this user.</p></div>
                    </div>
                </div>
            </div>
            <div style="background-color: white; width: 640px; padding-left: 35px; padding-right: 35px;">
                <b><p style="font-size: 20px;"><?php echo 'Welcome, ' . $_SESSION['username'] . '.'; ?></p></b>
                <div style="font-size: 12px;">
                    <p style="color:gray; text-align: justify;">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed 
                    ...
                    <p style="color:gray; text-align: justify;">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed 
                        ...
                        odio morbi quis commodo odio aenean. Interdum velit laoreet id donec ultrices. 
                        Viverra nibh cras pulvinar mattis nunc sed.</p>
                    <b><p style="margin-top: 40px; color: #fd455c;">Favorites:</p></b>
                    <div style="padding-left: 15px;">
                        <p><?php echo $_SESSION['Favorites'];?></p>
                    </div>
                    <b><p style="color: #fd455c;">Following:</p></b>
                    <div style="padding-left: 15px;">
